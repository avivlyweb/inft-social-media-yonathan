...
export function SuccessIcon({ size = 40, color = "currentColor", className, duration = 2200, active }: StateIconProps) {
  const auto = useAutoToggle(duration);
  const done = active !== undefined ? active : auto;
  return (
...
export function MenuCloseIcon({ size = 40, color = "currentColor", className, duration = 2000, active }: StateIconProps) {
  const auto = useAutoToggle(duration);
  const open = active !== undefined ? active : auto;
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
/* ─── 3. PLAY → PAUSE ─── */
export function PlayPauseIcon({ size = 40, color = "currentColor", className, duration = 2400, active }: StateIconProps) {
  const auto = useAutoToggle(duration);
  const playing = active !== undefined ? active : auto;
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function LockUnlockIcon({ size = 40, color = "currentColor", className, duration = 2600, active }: StateIconProps) {
  const auto = useAutoToggle(duration);
  const unlocked = active !== undefined ? active : auto;
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function CopiedIcon({ size = 40, color = "currentColor", className, duration = 2200, active }: StateIconProps) {
  const auto = useAutoToggle(duration);
  const copied = active !== undefined ? active : auto;
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function NotificationIcon({ size = 40, color = "currentColor", className, duration = 2800, active }: StateIconProps) {
  const auto = useAutoToggle(duration);
  const notif = active !== undefined ? active : auto;
  return (
...
export function HeartIcon({ size = 40, color = "currentColor", className, duration = 2000, active }: StateIconProps) {
  const auto = useAutoToggle(duration);
  const filled = active !== undefined ? active : auto;
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
      <motion.path
...
export function DownloadDoneIcon({ size = 40, color = "currentColor", className, duration = 2400, active }: StateIconProps) {
  const auto = useAutoToggle(duration);
  const done = active !== undefined ? active : auto;
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function SendIcon({ size = 40, color = "currentColor", className, duration = 2600, active }: StateIconProps) {
  const auto = useAutoToggle(duration);
  const sent = active !== undefined ? active : auto;
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
      <motion.g
        animate={sent
...
export function ToggleIcon({ size = 40, color = "currentColor", className, duration = 1800, active }: StateIconProps) {
  const auto = useAutoToggle(duration);
  const on = active !== undefined ? active : auto;
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function EyeToggleIcon({ size = 40, color = "currentColor", className, duration = 2200, active }: StateIconProps) {
  const auto = useAutoToggle(duration);
  const hidden = active !== undefined ? active : auto;
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function VolumeIcon({ size = 40, color = "currentColor", className, duration = 2400, active }: StateIconProps) {
  const auto = useAutoToggle(duration);
  const muted = active !== undefined ? active : auto;
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
