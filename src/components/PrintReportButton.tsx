      ...
      >
        {hasPrinted ? (
          <>
            ...
            <span>Afdrukvenster geopend</span>
          </>
        ) : (
          <>
            <Printer className="h-4 w-4 text-indigo-500" />
            <span>Exporteer / Print Rapport</span>
          </>
        )}
      </button>
    );
    ...
    >
      {hasPrinted ? (
        <>
          ...
          <span>Afdrukmenu geopend...</span>
        </>
      ) : (
        <>
          <Printer className="h-4 w-4 group-hover:scale-110 transition-transform text-cyan-400 dark:text-indigo-600" />
          <span>Exporteer / Print Onderzoeksrapport</span>
